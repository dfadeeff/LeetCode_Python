...
if __name__ == "__main__":
    ...
    print(solution.calculate(5, 16))  # == 56
    print(solution.calculate(0, 9000))  # == 1 + 3 + 5 + 6 + 7 + 10 + 13 + 15 + 18
    print(solution.calculate(7, 7))  # == 7
    print(solution.calculate(14, 18))  # == 33
    print(solution.calculate(3, 6))  # == 14
